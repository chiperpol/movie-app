                        ...
                        <tr>
                            ...
                            <td>
                                <div class="main__table-btns">
                                    <a href="{{ route('genre.edit', ['id' => $genre->id]) }}" class="main__table-btn main__table-btn--edit">
                                    ...
                                    <form method="POST" action="{{ route('genre.destroy', $genre->id) }}">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="main__table-btn main__table-btn--delete delete_confirm" data-nama-genre="{{ $genre->nama_genre }}">
...
<script type="text/javascript">
    ...
    $('.delete_confirm').click(function(event) {
        ...
        var namaGenre = $(this).data('nama-genre');

        event.preventDefault();
        swal.fire({
        title: 'Hapus genre ' + namaGenre + '?',
        text: "Genre " + namaGenre + " akan dihapus permanen!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire(
            'Berhasil!',
            'Genre ' + namaGenre + 'berhasil dihapus.',
            'success'
            )
        }
    });
