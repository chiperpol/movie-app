        ...
        <div class="col-12">
            <div class="main__title">
                ...
                <div class="main__title-wrap">
                    ...
                    <a href="#" class="main__title-link"><i class="icofont-plus mr-2"></i> Negara</a>
                </div>
            </div>
        </div>
        <!-- end main title -->
                ...
                <table class="main__table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="main__table-text">Horror</div>
                            </td>
                            <td><div class="main__table-text main__table-text--red">Inactive</div></td>
                            <td>
