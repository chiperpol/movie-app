<div class="sidebar">
    ...
    <ul class="sidebar__nav">
        <li class="sidebar__nav-item ">
            <a href="{{ route('dashboard.index') }}" class="sidebar__nav-link {{ Request::is('movie-app/dashboard') ? 'sidebar__nav-link--active' : '' }}">
        ...
        <li class="sidebar__nav-item">
            <a href="{{ route('movies.index') }}" class="sidebar__nav-link {{ Request::is('movie-app/movies') ? 'sidebar__nav-link--active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li class="sidebar__nav-item">
            <a class="sidebar__nav-link {{ Request::is('movie-app/negara') ? 'sidebar__nav-link--active' : '' }}" data-toggle="collapse" href="#collapseMenu" role="button" aria-expanded="false" aria-controls="collapseMenu">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <ul class="collapse sidebar__menu" id="collapseMenu">
                <li><a href="{{ route('negara.index') }}" class="{{ Request::is('movie-app/negara') ? 'active' : '' }}">Negara</a></li>
