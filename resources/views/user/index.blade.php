    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="main__title">
                ...
                <span class="main__title-stat">Total {{ $countUser }}</span>
                ...
                <div class="main__title-wrap">
                    ...
                    <a href="{{ route('users.add') }}" class="main__title-link"><i class="icofont-plus mr-2"></i> User</a>
                </div>
            </div>
        </div>
        <!-- end main title -->
...
<script type="text/javascript">
    ...
    $('.delete_confirm').click(function(event) {
        ...
        var judulMovie = $(this).data('judul-movie');

        event.preventDefault();
        swal.fire({
        title: 'Hapus film ' + judulMovie + '?',
        text: "Film " + judulMovie + " akan dihapus permanen!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire(
            'Berhasil!',
            'Film ' + judulMovie + 'berhasil dihapus.',
            'success'
            )
        }
    });
