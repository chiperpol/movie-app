    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="main__title">
                ...
                <span class="main__title-stat">{{ $countNegara }} total</span>

                <div class="main__title-wrap">
                    <form action="#" class="main__title-form mr-4">
                        <input type="text" placeholder="Find country..">
                        <button type="button">
                    ...
                    <a href="{{ route('negara.add') }}" class="main__title-link"><i class="icofont-plus mr-2"></i> Negara</a>
                </div>
            </div>
        </div>
        <!-- end main title -->
                ...
                <table class="main__table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="main__table-text">{{ $negara->nama_negara }}</div>
                            </td>
                            <td>
                                @if ($negara->status == 1)
                            ...
                            <td>
                                <div class="main__table-btns">
                                    <a href="{{ route('negara.edit', ['id' => $negara->id]) }}" class="main__table-btn main__table-btn--edit">
...
<script type="text/javascript">
    ...
    $('.show_confirm').click(function(event) {
        ...
        text: "Negara " + namaNegara + " akan dihapus permanen!",
        icon: 'warning',
