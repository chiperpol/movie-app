    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="main__title">
                <h2>Master Quality</h2>

                <span class="main__title-stat">{{ $countQualitys }} total</span>

                <div class="main__title-wrap">
                    <form action="#" class="main__title-form mr-4">
                        <input type="text" placeholder="Find quality..">
                        <button type="button">
                    ...
                    <a href="{{ route('quality.create') }}" class="main__title-link"><i class="icofont-plus mr-2"></i> Quality</a>
                </div>
            </div>
        </div>
        <!-- end main title -->
                ...
                <table class="main__table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="main__table-text">{{ $quality->nama_quality }}</div>
                            </td>
                            <td>
                                @if ($quality->status == 1)
                            ...
                            <td>
                                <div class="main__table-btns">
                                    <a href="{{ route('quality.edit', ['quality' => $quality->id]) }}" class="main__table-btn main__table-btn--edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,7.24a1,1,0,0,0-.29-.71L17.47,2.29A1,1,0,0,0,16.76,2a1,1,0,0,0-.71.29L13.22,5.12h0L2.29,16.05a1,1,0,0,0-.29.71V21a1,1,0,0,0,1,1H7.24A1,1,0,0,0,8,21.71L18.87,10.78h0L21.71,8a1.19,1.19,0,0,0,.22-.33,1,1,0,0,0,0-.24.7.7,0,0,0,0-.14ZM6.83,20H4V17.17l9.93-9.93,2.83,2.83ZM18.17,8.66,15.34,5.83l1.42-1.41,2.82,2.82Z"/></svg>
                                    </a>
                                    <form method="POST" action="{{ route('quality.destroy', $quality->id) }}">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="main__table-btn main__table-btn--delete delete_confirm" data-nama-quality="{{ $quality->nama_quality }}">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
    <h6 class="modal__title">Hapus Negara</h6>

    <p class="modal__text">Hapus negara Indonesia?</p>

    <div class="modal__btns">
        <button class="modal__btn modal__btn--apply" type="button">Hapus</button>
        <button class="modal__btn modal__btn--dismiss" type="button">Batal</button>
    </div>
</div>
@endsection
...
<script type="text/javascript">
    ...
    $('.delete_confirm').click(function(event) {
        ...
        var namaQuality = $(this).data('nama-quality');

        event.preventDefault();
        swal.fire({
        title: 'Hapus quality ' + namaQuality + '?',
        text: "Quality " + namaQuality + " akan dihapus permanen!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire(
            'Berhasil!',
            'Quality ' + namaQuality + 'berhasil dihapus.',
            'success'
            )
        }
    });
